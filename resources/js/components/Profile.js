  ...
  render() {
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-sm-6">{this.state.eventsCreated.map(events => ( <p> <Link to={"/event/"+events.id}>{events.title}</Link> <div className="float-right"> <i className="fa fa-edit"></i> <a href="javascript:void()" onClick={() => this.cancelEvent(events.id)}><i className="fa fa-trash"></i></a></div> </p>))}</div>
